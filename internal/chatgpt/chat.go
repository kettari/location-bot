...
date - дата и время игры в формате ISO 8601 с таймзоной Москвы. Дату найди в элементе "p" с классом "subcaption-h4". Время найди в элементе "h4" с классом "game-title".
