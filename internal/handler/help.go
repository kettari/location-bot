...
const commonHelp = `Этот бот умеет высылать список игр, на которые можно записаться в Локации (https://rolecon.ru/). 

Всё настраивается на сервере, на запросы пользователей бот (пока) не отвечает. Команды:
